...
const LoginForm = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center ">
            <div className="w-full max-w-5xl flex rounded-3xl overflow-hidden shadow-2xl h-[600px]">
                {/* Lado esquerdo: Login */}
                <div className="w-1/2 h-full bg-[#23242a] flex flex-col justify-center items-center p-10">
                    <h2 className="text-4xl font-bold text-white mb-8 text-center">Fazer login</h2>
                ...
                <div className="w-1/2 h-full flex flex-col justify-center items-center bg-gradient-to-br from-white to-[#d1c4e9] p-10 relative">
                    <div className="text-center">
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">Não tem uma conta?</h2>
                        <p className="text-gray-600 mb-8">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                        <button
                            onClick={() => history.push('/register')}
                            className="px-8 py-3 border border-gray-400 rounded-full text-gray-800 font-semibold hover:bg-gray-100 transition text-lg"
                        >
                            Cadastre-se
                        </button>
                    </div>
